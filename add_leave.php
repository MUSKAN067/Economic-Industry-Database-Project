...
if (isset($_POST['submit'])) {
	...
	$sql = "insert into `leave`(date, Vehicle_No, In_Time, employee_id, Weight_without_Material, Weight_with_Material, Gross_Wt,Out_Time,Vehicle_Type, Project_Name, leave_status) 
	...
	header('Location: loading-point.php');
	die();
}
?>
<style>
...
<div class="content pb-0">
	<div class="animated fadeIn">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header" style="text-align: center;"><strong>Loading Point</strong></div>
					<div class="card-body card-block">
						<form method="post">

							<div class="form-group">
								<label class=" form-control-label">Loading Project Name</label>
