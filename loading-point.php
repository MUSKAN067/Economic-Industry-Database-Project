   ...
   <div class="orders">
      <div class="row">
         <div class="col-xl-12">
            <div class="card">
               <div class="card-body">
                  <h4 class="box-title" style="float: left;">Loading Point </h4>
                  <?php if ($_SESSION['ROLE'] == 3) { ?>
                     <button class="add_button"><a href="add_leave.php" style="color: aliceblue; ">Add Point</a> </button>
                  <?php } ?>
               </div>
               <div class="card-body--">
                           ...
                           while ($row = mysqli_fetch_assoc($res)) { ?>
                              <tr>
                                 ...
                                 <td data-label="Modes">
                                    ...
                                    ?>
                                    <?php
                                    if ($row['leave_status'] == 1 && $_SESSION['ROLE'] == 3) { ?>
                                       <a href="loading-point.php?id=<?php echo $row['id'] ?>&type=delete">Delete</a>
                                    <?php } ?>
                                 </td>
...
<script>
   function update_leave_status(id, select_value) {
      window.location.href = 'loading-point.php?id=' + id + '&type=update&status=' + select_value;
   }
</script>
<?php
